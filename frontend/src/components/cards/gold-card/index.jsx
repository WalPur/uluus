...
const GoldCard = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text16 sx={{ mb: 1 }}>{data.name}</Text16>
        <Text12 sx={{ flexGrow: 1, mb: 1 }}>{data.description}</Text12>
        <Text14 sx={{ mb: 1 }}>{data.price} рублей</Text14>
        <Box
          sx={{
            display: "flex",
            flexWrap: "wrap",
        ...
        >
          <Text12>{date.toLocaleString().slice(0, -3)}</Text12>
          <a
